...
/*
 ...
 Version: 0.86 July 18, 2017 (Updated since this version by Wetbikeboy2500)
 ...
 AntÃ³nio Afonso, to read .sb2 files and compressed projects, and the canvg 
...
var P = (function() {
  ...
  var Stage = function() {
    ...
    this.promptButton.style.background = 'url(/img/icons.svg) -165em -37em';
  ...
  Stage.prototype.setZoom = function(zoomX, zoomY) {
    ...
    this.root.style.fontSize = ps + 'px';
    this.zoomX = zoomX;
	this.zoomY = zoomY;
    this.updateBackdrop();
  };
...
P.runtime = (function() {
  ...
  if (audioContext) {
    ...
    volumeNode.gain.setTargetAtTime(VOLUME, audioContext.currentTime, 0.015);
